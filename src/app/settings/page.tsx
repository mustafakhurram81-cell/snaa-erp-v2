...
import { PageHeader, Button, Card, Input, Tabs } from "@/components/ui/shared";
...
export default function SettingsPage() {
    ...
    const tabs = [
        { key: "general", label: "General", icon: <Building2 className="w-3.5 h-3.5" /> },
        { key: "preferences", label: "Preferences", icon: <Bell className="w-3.5 h-3.5" /> },
        { key: "security", label: "Security & Profile", icon: <Lock className="w-3.5 h-3.5" /> },
        { key: "users", label: "User Management", icon: <Users className="w-3.5 h-3.5" /> },
        { key: "data", label: "Data & Backup", icon: <Database className="w-3.5 h-3.5" /> },
    ];
